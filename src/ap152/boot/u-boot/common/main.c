...
#define FW_IMAGE_UPLOAD_CMD     "tftp 80800000 "
...
#endif
			/* Add for supportting both up_boot.bin and up.bin, wuchao@2014-10-28 */
            ...
            {       
				...
				printf("original_product_id = %d, original_product_ver = %d\n", original_product_id, original_product_ver);
				printf("recovery_product_id = %d, recovery_product_ver = %d\n", recovery_product_id, recovery_product_ver);
