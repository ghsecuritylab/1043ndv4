...
#define USE_WAITPID
#define USE_SYSV_IPC
#define NO_SEMUN	/*this is just for our system!*/
#if 0
...
********************************************************************/
#define USE_MMAP 0	//do not use mmap on our platform since our memory is very limited on user space!

#if (USE_MMAP == 1) || defined(FAST_SHARE_MODES)
#include <sys/mman.h>
#endif
...
#include "proto.h"	//include the function-contained .h file at last!
