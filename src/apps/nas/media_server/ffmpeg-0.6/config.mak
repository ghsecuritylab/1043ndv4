...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/jji315/mount1/qca_branch/build/../apps/nas/media_server/ap152 --libdir=/home/jji315/mount1/qca_branch/build/../apps/nas/media_server/ap152/lib --enable-static --disable-ffmpeg --disable-ffserver --disable-ffplay --disable-ffprobe --disable-zlib --disable-bzlib --disable-indev=alsa --disable-outdev=alsa --enable-cross-compile --target-os=linux --arch=mips
...
SRC_PATH=/home/jji315/mount1/qca_branch/apps/nas/media_server/ffmpeg-0.6
SRC_PATH_BARE=/home/jji315/mount1/qca_branch/apps/nas/media_server/ffmpeg-0.6
BUILD_ROOT=/home/jji315/mount1/qca_branch/apps/nas/media_server/ffmpeg-0.6
ARCH=mips
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -Werror=implicit -Werror=missing-prototypes
ASFLAGS=   -g
CC_O=-o $@
